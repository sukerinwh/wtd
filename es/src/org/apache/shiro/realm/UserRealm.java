...
import com.wtd.es.common.repository.support.SimpleBaseRepositoryFactoryBean;
import com.wtd.es.sys.auth.service.UserAuthService;
import com.wtd.es.sys.user.entity.User;
import com.wtd.es.sys.user.exception.*;
...
System.out.println(userAuthService.findStringPermissions(user));
