 ...
 */
package com.wtd.es.common.web.controller;

import com.wtd.es.common.Constants;
import com.wtd.es.common.db.oracle.DbConnection;
import com.wtd.es.common.entity.AbstractEntity;
...
import com.wtd.es.common.web.controller.permission.PermissionList;
...
public abstract class BaseCRUDController<M extends AbstractEntity, ID extends Serializable>
    ...
    public String deleteInBatch(
        ...
        if(baseService.toString().startsWith("com.wtd.es.customer.upload.service.PideUploadService")){
        	String[] pras = new String [10] ;
        	sb.append(" delete from  sapsr3.zpidedoc  where zid = ");
        	for (int i=0;i<ids.length;i++){
        		pras[i] = ids[i].toString();
        		if(i==0){
                    sb.append("'").append(pras[i]).append("'");
        		}else{
        			sb.append(" or ").append(" zid = '").append(pras[i]).append("'");
        		}
        	};
