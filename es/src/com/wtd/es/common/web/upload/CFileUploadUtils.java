 ...
 */
package com.wtd.es.common.web.upload;

import com.wtd.es.common.utils.LogUtils;
import com.wtd.es.common.utils.security.Coder;
import com.wtd.es.common.web.upload.exception.FileNameLengthLimitExceededException;
import com.wtd.es.common.web.upload.exception.InvalidExtensionException;
...
public class CFileUploadUtils {
    ...
    public static void setDefaultBaseDir(String defaultBaseDir) {
        CFileUploadUtils.defaultBaseDir = defaultBaseDir;
    }
    ...
    public static final String upload(
        ...
        if (fileNamelength > CFileUploadUtils.DEFAULT_FILE_NAME_LENGTH) {
            throw new FileNameLengthLimitExceededException(file.getOriginalFilename(), fileNamelength, CFileUploadUtils.DEFAULT_FILE_NAME_LENGTH);
        }
    ...
    public static final String extractFilename(MultipartFile file, String baseDir, boolean needDatePathAndRandomName)
        ...
        if(needDatePathAndRandomName) {
        	...
        	filename = baseDir + File.separator + datePath() + File.separator + filename;
