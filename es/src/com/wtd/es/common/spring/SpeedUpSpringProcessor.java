 ...
 */
package com.wtd.es.common.spring;
...
public class SpeedUpSpringProcessor implements BeanFactoryPostProcessor {
    ...
    private boolean needRemove(String beanName, BeanDefinition beanDefinition) {
        ...
        //spring data jpa
        if(className.equals("com.wtd.es.common.repository.support.SimpleBaseRepositoryFactoryBean") ||
    ...
    public static void main(String[] args) {
        String c = "com.wtd.es.sys.user.web.bind.A";
        System.out.println(c.matches("com\\.wtd\\.es\\.sys.*\\.web\\.controller.*"));
    }
}
